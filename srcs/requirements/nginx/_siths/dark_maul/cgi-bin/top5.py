...
<head>
  ...
  <style>
    ...
    * {{ margin: 0; padding: 0; box-sizing: border-box; }}
    ...
    /* Fallback si pas d'image : emoji centré */
    .mini-img-fallback {{
      width: 150px;
      height: 150px;
      border-radius: 4px;
...
for s in siths:
    ...
    url_js  = s.get('url', '')
    sith_data_js += f"  {s['rank']}: {{ name: '{name_js}', desc: '{desc_js}', fun: '{fun_js}', url: '{url_js}' }},\n"
sith_data_js += "};"
...
<div class="detail-panel" id="detail">
  ...
  <a id="detail-link" href="#" target="_blank" style="display:none;margin-top:16px;padding:10px 24px;background:transparent;border:1px solid {accent};color:{accent};font-family:sans-serif;font-size:0.95rem;letter-spacing:1px;text-decoration:none;border-radius:2px;transition:all 0.3s;display:none;width:fit-content;">
    ⚡ Visiter le site
  </a>
</div>
